...
class TourForgeConfig {
  ...
  /// Optional hook invoked once when the home screen first appears, with a
  /// valid [BuildContext]. The consumer app uses this for an in-app update
  /// check. Kept in the engine so the baseline stays app-agnostic.
  final Future<void> Function(BuildContext context)? onStartup;
